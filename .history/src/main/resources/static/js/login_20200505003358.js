...
if (verImg.length) {
  ...
  imgBox.prepend(`<img class='verImg' src="D:\文档\GitHub\demo\src\main\resources\static/imgs/${imgs[index]}.jpg" />`)
}
verify.css('background-image', `url('D:\文档\GitHub\demo\src\main\resources/static/imgs/${imgs[index]}.jpg')`)
}
