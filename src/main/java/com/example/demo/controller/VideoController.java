...
public class VideoController {
    ...
    @PostMapping(value = "/govideoupload")
    public String VideoUpload(String title, MultipartFile file, HttpServletRequest request) throws Exception {
        ...
        String videoName = file.getOriginalFilename(); //获取上传后文件的名字
