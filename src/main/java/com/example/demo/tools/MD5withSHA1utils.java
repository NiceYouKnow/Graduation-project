...
public class MD5withSHA1utils {
  ...
  /**
   ...
   public static void main(String[] args) {
      ...
      String plaintext = "rs.getPassword()";
      // 获取加盐后的MD5值
      String ciphertext = MD5withSHA1utils.getSaltMd5AndSha(plaintext);
      // String sqlt = getsalt();
      System.out.println("加盐后MD5：" + ciphertext);
      // System.out.println("盐：" + sqlt);
      System.out.println("是否是同一字符串:" + MD5withSHA1utils.getSaltverifyMd5AndSha(plaintext, ciphertext));
      rs.setPassword(ciphertext);
   }
}